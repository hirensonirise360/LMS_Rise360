...
# RISE360 Institute LMS: Open source learning management system
...
If you would like to contribute, please refer to the issues page or contact the maintainers.
...
```bash
git clone https://github.com/SkyCascade/RISE360 Institute.git
```
